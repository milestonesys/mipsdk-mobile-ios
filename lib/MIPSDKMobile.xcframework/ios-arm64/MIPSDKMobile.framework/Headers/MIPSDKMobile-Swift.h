...
/// GetTileServers - returns a list of addresses, providing tiles for the Smart maps feature.
+ (XPSDKRequest * _Nonnull)getTileServersWithSuccessHandler:(void (^ _Nullable)(XPSDKResponse * _Nullable))successHandler failureHandler:(void (^ _Nullable)(NSError * _Nullable))failureHandler;
/// Adds Delegate
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull XPSDKSupportsSmartMap;)
+ (NSString * _Nonnull)XPSDKSupportsSmartMap SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull XPSDKGetTileServers;)
+ (NSString * _Nonnull)XPSDKGetTileServers SWIFT_WARN_UNUSED_RESULT;
