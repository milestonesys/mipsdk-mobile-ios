...
struct Constants {
    ...
    struct Login {
        static let loginScreenTitle = "Mobile SDK Direct Streaming Video Sample"
        ...
        static let loginAboutMessage = "Milestone SDK Direct Streaming Video Sample\nFor more information visit www.milestonesys.com."
    }
    ...
    struct RequestStreamParameters {
        static let streamType = "FragmentedMP4"
