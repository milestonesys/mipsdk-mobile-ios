...
/// Creates bookmark for a video with a description
/// More details about the GetCapabilities command could be found in the Mobile Server Protocol documentation.
...
///
- (void)setupWithURLString:(NSString * _Nonnull)urlString uuid:(NSString * _Nullable)uuid;
...
///
- (nonnull instancetype)initWithUrlString:(NSString * _Nonnull)urlString uuid:(NSString * _Nullable)uuid;
