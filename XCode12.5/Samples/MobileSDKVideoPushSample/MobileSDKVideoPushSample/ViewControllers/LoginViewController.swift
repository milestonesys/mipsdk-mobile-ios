...
class LoginViewController: UIViewController {
    ...
    @IBAction func login(_ sender: Any) {
        ...
        XPMobileSDK.connectAndLoginForServerInfo(serverInfo,
            ...
            weakSelf.performSegue(withIdentifier: Constants.Login.cameraSegueIdentifier, sender: sender)
        }, failureHandler: { [weak self] (error) in
            self?.activityIndicator.stopAnimating()
            self?.alert(withTitle: Constants.Login.loginErrorTitle, message: Constants.Login.loginErrorMessage)
        })
    }
    ...
    private func alert(withTitle title: String, message: String) {
        ...
        let defaultAction = UIAlertAction(title: Constants.Login.loginAlertOK,
                                          style: .default,
                                          handler: nil)
