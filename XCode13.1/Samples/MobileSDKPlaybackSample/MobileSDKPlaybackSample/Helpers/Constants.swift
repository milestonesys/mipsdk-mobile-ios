...
struct Constants {
    ...
    //MARK: CameraPlaybaclViewController
    ...
    static let playbackStateLog = "Playback state: "
    ...
    struct Login {
        static let loginScreenTitle = "Mobile SDK Playback Video Sample"
        ...
        static let loginAboutMessage = "Milestone SDK Playback Video Sample\nFor more information visit www.milestonesys.com."
    }
